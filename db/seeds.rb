...
Speech.create([
                ...
                { id: 8, text: 'introduction-5', rabbit_id: 1, colored_words: %w[search bushes hide] },
...
Speech.create([
                ...
                { id: 12, text: 'hint-ginny', rabbit_id: 1, speech_type: 'hint', colored_words: %w[drop a carrot] },
                { id: 13, text: 'hint-remmy', rabbit_id: 1, speech_type: 'hint',
                  colored_words: ["doesn't", 'like', 'small', 'spaces'] },
                { id: 14, text: 'hint-debbie', rabbit_id: 1, speech_type: 'hint', colored_words: ['console'] },
                { id: 15, text: 'hint-larry', rabbit_id: 1, speech_type: 'hint', colored_words: %w[understands fives] },
                { id: 16, text: 'hint-steevie', rabbit_id: 1, speech_type: 'hint', colored_words: %w[shout this name] },
                { id: 17, text: 'hint-sergie', rabbit_id: 1, speech_type: 'hint', colored_words: %w[keep right path] },
                { id: 18, text: 'hint-appie', rabbit_id: 1, speech_type: 'hint',
                  colored_words: ["Appie's", 'key', 'DOMain'] },
                { id: 19, text: 'hint-timmy', rabbit_id: 1, speech_type: 'hint', colored_words: %w[too lighter] },
